...
const Footer: React.FC<FooterProps> = ({ better }) => {
        ...
        <div className="lg:flex justify-between w-full">
          <Link href="/">
            <p className="cursor-pointer flex items-center font-semibold text-2xl">
              <span className="bg-[#04050E] dark:bg-[#f363ac] text-xs px-2 py-1 mr-2 rounded-lg">
          ...
          <div className="lg:flex space-x-6 items-center">
            <div className="text-left mt-2 lg:mt-0 lg:text-right">
              <p>
                {k4itrunConfig.name} &copy; 2020 - {new Date().getFullYear()}, All rights reserved.
              </p>
