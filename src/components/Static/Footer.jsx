    ...
    return <>
        <div className="max-w-7xl mx-auto py-12 border-t border-gray-500/10">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
                <p className="text-lg text-zinc-400">© 2018 - {new Date().getFullYear()} {k4itrunConfig.name}. All rights reserved.</p>
                <div className="text-right">
                    ...
                    <p className="text-sm text-zinc-400 select-none">Powered by <a href="https://vercel.com/" className="text-zinc-400 hover:text-primary hover:dark:text-white">Vercel</a></p>
                </div>
            </div>
        </div>
    </>
